...
func TestCodexStartConfiguresLiteLLMSubscriptionProvider(t *testing.T) {
	...
	require.NotContains(t, script, `trusted_project_dirs`)
	require.NotContains(t, script, `project_headers`)
	require.NotContains(t, script, `trusted_headers`)
	require.NotContains(t, script, `trust_level = "trusted"`)
