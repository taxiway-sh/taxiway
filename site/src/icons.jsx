...
/* Shared inline icon set for the TaxiWay landing kit.
   Stroke icons in the Lucide style (the documented icon system). */
export const TWIcon = ({ name, size = 24, stroke = 2, color = 'currentColor', style = {} }) => {
  const paths = {
